...
public class SubtypeCalculated {
	...
	public String toString() {
		return "seqFootXScaled: "+this.seqFootXScaled+", seqFootYScaled: "+this.seqFootYScaled+", seqFootX: "+this.seqFootX+", seqFootY: "+this.seqFootY+", frameList_vector: "+this.frameList_vector.toString()+", numFrames: "+this.numFrames;
	}
}
